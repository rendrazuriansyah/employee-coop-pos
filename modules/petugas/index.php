...
if ($search) {
    $users = $petugas->searchUsers($search);
    $totalUsers = count($users);
    $totalPages = 1;
} else {
    $users = $petugas->getUsersWithLevel();
    $totalUsers = count($users);
...
<head>
    ...
    <title>Data Petugas - Koperasi Pegawai RSUD Tarakan</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($usr['id_user']) ?></td>
                                        <td><?= htmlspecialchars($usr['nama_user']) ?></td>
                                        <td><?= htmlspecialchars($usr['username']) ?></td>
                                        <td>
                                            <span class="badge bg-<?= $usr['level'] == 1 ? 'danger' : ($usr['level'] == 2 ? 'info' : 'warning') ?>">
                                                <?= ucfirst($usr['level_name']) ?>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="view.php?id=<?= $usr['id_user'] ?>" 
                                                   class="btn btn-info btn-sm" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="edit.php?id=<?= $usr['id_user'] ?>" 
                                                   class="btn btn-warning btn-sm" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <?php if ($usr['username'] !== 'admin'): ?>
                                                <button type="button" class="btn btn-danger btn-sm" 
                                                        onclick="deleteUser(<?= $usr['id_user'] ?>)" title="Delete">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-muted">
                                    ...
                                    <?= min($page * $perPage, $totalUsers) ?> of 
                                    <?= $totalUsers ?> entries
                                </p>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <strong>Catatan Keamanan:</strong> Hanya administrator yang dapat mengakses halaman ini. 
                            Pastikan untuk memberikan akses yang sesuai dengan kebutuhan masing-masing petugas.
                        </div>
                    </div>
                </div>
            </main>
