...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $petugas->createUser($data);
            header('Location: index.php?success=Petugas berhasil ditambahkan');
            exit;
        } catch (Exception $e) {
            $errors[] = 'Gagal menambahkan petugas: ' . $e->getMessage();
        }
    }
}
?>
...
<head>
    ...
    <title>Tambah Petugas - Koperasi Pegawai RSUD Tarakan</title>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">
                                            <small>
                                                ...
                                                <strong>Manager:</strong> Akses laporan dan monitoring<br>
                                                <strong>Kasir:</strong> Akses transaksi dan data customer/item
                                            </small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        ...
                                        <strong>Catatan:</strong> Pastikan data yang dimasukkan sudah benar. 
                                        Petugas akan dapat login menggunakan username dan password yang dibuat.
                                    </div>
                                </div>
                            </div>
