...
if ($search) {
    ...
    $result = $customer->paginate($page, $perPage);
...
<head>
    ...
    <title>Data Customer - Koperasi Pegawai RSUD Tarakan</title>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($cust['id_customer']) ?></td>
                                        <td><?= htmlspecialchars($cust['nama_customer']) ?></td>
                                        <td><?= htmlspecialchars($cust['alamat'] ?? '-') ?></td>
                                        <td><?= htmlspecialchars($cust['telp'] ?? '-') ?></td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="view.php?id=<?= $cust['id_customer'] ?>" 
                                                   class="btn btn-info btn-sm" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="edit.php?id=<?= $cust['id_customer'] ?>" 
                                                   class="btn btn-warning btn-sm" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button type="button" class="btn btn-danger btn-sm" 
                                                        onclick="deleteCustomer(<?= $cust['id_customer'] ?>)" title="Delete">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-muted">
                                    ...
                                    <?= min($page * $perPage, $totalCustomers) ?> of 
