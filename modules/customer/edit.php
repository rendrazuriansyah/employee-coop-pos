...
if ($_POST) {
    ...
    if (empty($errors)) {
        try {
            ...
            $errors[] = 'Gagal mengupdate customer: ' . $e->getMessage();
        }
    }
} else {
    $data = $customerData;
...
<head>
    ...
    <title>Edit Customer - Koperasi Pegawai RSUD Tarakan</title>
                ...
                <div class="card">
                    <div class="card-header bg-warning text-white">
                        <h5 class="mb-0">
                            ...
                            EDIT CUSTOMER - ID: <?= htmlspecialchars($customerData['id_customer']) ?>
                        </h5>
                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" 
                                               value="<?= date('d/m/Y H:i', strtotime($customerData['created_at'])) ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <a href="view.php?id=<?= $customerData['id_customer'] ?>" class="btn btn-info me-2">
